...
public class MainActivity111 extends AppCompatActivity implements View.OnClickListener, BaseQuestionPanel.QuestionPanelListener, ExtraQuestionPanel.ExtraPanelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentQuestion = mockQuestions.get(currentQuestionIndex);
        fillQuestion(null);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.question_answer) {
            ...
            if (questions.size() == 0) {
                ...
                Question preQuestion = questions.get(questions.size() - 1);
...
//                        fillQuestion(null);
    ...
    private void toNextQuestion() {
        if ((currentQuestionIndex + 1) >= mockQuestions.size()) {
            //网络获取下一题
